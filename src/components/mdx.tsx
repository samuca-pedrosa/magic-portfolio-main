...
function slugify(input: any): string {
  ...
  if (typeof input === 'string') {
    ...
    // Para objetos (incluindo elementos React), tenta extrair texto
    str = String(input);
  } else if (Array.isArray(input)) {
    // Se for array, junta todos os elementos
    str = input.map(child => 
  ...
  // Se ainda não temos uma string válida, retorna string vazia
